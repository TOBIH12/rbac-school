...
const LecturerDashboard = () => {
  ...
  return (
    <div className="w-full min-h-[90vh] bg-gray-100 mx-auto p-10">
     <h1 className="text-2xl md:text-3xl text-gray-800 mb-2">Lecturer Dashboard</h1>
...
<div className="w-full flex flex-col items-center justify-center">
      ...
      <h1 className="text-2xl md:text-3xl text-gray-800 mt-24">Quick Actions</h1>
         <div className="flex flex-col md:flex-row w-full mt-5 gap-5">
            ...
            <Link to={'/view_students'} className="flex flex-col gap-1 bg-gray-900 hover:bg-gray-800 text-white w-1/2 md:w-1/5 py-3 px-4 justify-center items-center rounded-lg transition-all ease-in duration-1000s">
            <h3 className="text-1xl mb-2">View Students</h3>
